...
const NewTodo = (): ReactElement => {
  ...
  return (
    <div className="flex w-4/5 mx-auto flex-col justify-start items-start">
      ...
      <form className="space-y-1 md:space-y-6  md:mt-5 w-full">
        ...
        <div>
          <button
            type="submit"
            className="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-xl/6 font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Sign in
          </button>
        </div>
