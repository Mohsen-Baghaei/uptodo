...
const IntroFourthPage = (): ReactElement => {
  ...
  return (
    <div className="w-4xl h-full mx-auto flex flex-col justify-between items-center">
      <div className="w-3/5 md:w-3/6 xl:w-1/5 p-4 mt-8">
        <img src={intro4} alt={intro4} className="w-full" />
      </div>
      <div className="flex flex-col items-center justify-center ">
        <div className="bg-slate-500 w-8 h-1 md:w-16 md:h-2  rounded  before:content-[''] before:bg-slate-500 before:w-8 before:h-1 before:md:w-16 before:md:h-2 before:rounded before:absolute before:-translate-x-10 md:before:-translate-x-20  after:content-[''] after:bg-slate-50 after:w-8 after:h-1 after:md:w-16 after:md:h-2 after:rounded after:absolute after:translate-x-10 md:after:translate-x-20 my-4 md:my-10"></div>
